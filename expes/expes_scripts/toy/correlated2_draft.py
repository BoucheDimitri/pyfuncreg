...
# ############################### Regressor config #####################################################################
REGU = np.geomspace(1e-11, 10, 200)
...
best_config_noreg = best_config_corr.copy()
best_config_noreg.pop("regu", None)
test_reg_regu = kpl.SeperableKPLRegpath(**best_config_noreg)
test_reg_regu.fit(Xtrain, Ytrain)
preds = test_reg_regu.predict_evaluate_diff_locs(Xtrain, Ytrain[0], best_config["regu"])
