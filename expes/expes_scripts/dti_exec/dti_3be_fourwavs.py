...
DOMAIN = np.array([[0, 1]])
LOCS_BOUNDS = np.array([[0 - SIGNAL_EXT_OUTPUT[1][0], 1 + SIGNAL_EXT_OUTPUT[1][1]]])
...
PYWT_NAME = ["db"]
N_DILATS = [4]
BASIS_DICT = {"pywt_name": PYWT_NAME, "moments": MOMENTS, "n_dilat": N_DILATS, "init_dilat": 1.0,
              "translat": 1.0, "dilat": 2, "approx_level": 6,
              "add_constant": True, "domain_out": DOMAIN, "locs_bounds_out": LOCS_BOUNDS}
...
if __name__ == '__main__':
    ...
    for i in range(N_AVERAGING):
        ...
        configs, regs = generate_expes.dti_3be_fourwavs(KER_SIGMA, REGU_GRID, CENTER_OUTPUT, FREQS_IN_GRID,
                                                        N_RFFS, RFFS_SEED, **BASIS_DICT, domain_in=DOMAIN)
