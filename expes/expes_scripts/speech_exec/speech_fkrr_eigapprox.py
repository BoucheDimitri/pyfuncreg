...
# Record config
OUTPUT_FOLDER = "/speech_fkrr_eigapprox2"
# Indexing
INPUT_INDEXING = "list"
...
KIN_SIGMA = 1
KOUT_SIGMA = [0.02, 0.04, 0.06, 0.08, 0.1, 0.125, 0.15]
...
if __name__ == '__main__':
    ...
    configs, regs = generate_expes.speech_fkrr_eigapprox(KIN_SIGMA, KOUT_SIGMA, REGU_GRID, NEIG,
