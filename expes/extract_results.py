...
# ############################ SPEECH ##################################################################################
path = "/home/dimitri/Desktop/Telecom/Outputs/all_outputs_08-06-2020_12-16/outputs/"
KEYS = ("LP", "LA", "TBCL", "TBCD", "VEL", "GLO", "TTCL", "TTCD")
# KEYS = ("LA", "TBCD", "TTCD", "VEL")
# KEYS = ("LP", "LA", "TBCL", "GLO", "TTCL", "TTCD")

folders_speech = ["speech_fkrr_multi", "speech_fkrr_biggrid"]
...
#
with open(path + "speech_kpl_rffs75_max/9_VEL.pkl", "rb") as inp:
